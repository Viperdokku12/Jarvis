...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'deavo;dessa;https://cdn.ironman.my.id/i/zzs6om.jpg',
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_4063_7u57_x6y1_684z_7z39_w58w_380w_21y6',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "dessa", "body": "ᴀᴡᴇꜱᴏᴍᴇ 🍉", "thumbnailUrl": "https://cdn.ironman.my.id/i/zzs6om.jpg", "renderLargerThumbnail": false, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/Loki-Xer/Jarvis", "showAdAttribution": true}`,
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'deavo;dessa',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;dessa;https://cdn.ironman.my.id/i/zzs6om.jpg',
  ...
  BOT_INFO: process.env.BOT_INFO || 'dessa;deavo;https://cdn.ironman.my.id/i/zzs6om.jpg',
